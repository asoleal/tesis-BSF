...
\begin{frame}{Marco General: Sistema Híbrido Físico-Digital}
    \begin{columns}[T]
        ...
        \begin{block}{1. El Desafío: La ``Caja Negra''}
            Actualmente, para conocer el estado de las larvas hay que abrir el biorreactor, alterando el proceso. Además, existe alta incertidumbre en la medición de emisiones (GEI), especialmente CO$_2$ y CH$_4$. Por ahora no se medirán otros gases
        \end{block}
