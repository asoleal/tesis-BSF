...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Duraci\'on: 10--14 d\'ias~\cite{dienerConversionOrganicMaterial2011,surendra2016bioconversion}
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Dieta y respiración parcialmente caracterizadas} $\rightarrow$ modelos DEB \parencite{eriksenDynamicModellingFeed2022,padmanabhaComprehensiveDynamicGrowth2020} y estudios de metabolismo larval \parencite{bekker2021impact,rossi2024estimating} describen flujos de carbono y efecto del sustrato, pero su acoplamiento con monitoreo continuo para predicción operativa de CO$_2$ y riesgo de anaerobiosis no está implementado
