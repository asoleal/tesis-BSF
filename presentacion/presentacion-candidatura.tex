...
mundial~\cite{lacknerAgriculturalWasteChallenges2025,kongEvaluatingGreenhouseGas2012}. 
En condiciones de descomposici\'on anaerobia 
---vertederos mal manejados, compostaje deficiente--- 
se generan~\cite{nordahlGreenhouseGasAir2023a}:
...
\footnotesize
El pa\'{i}s ratific\'{o} la meta de reducir \textbf{51\%} de sus emisiones proyectadas al 2030. Los residuos agroindustriales mantienen peso creciente en el perfil nacional de GEI seg\'{u}n el IDEAM \cite{tiriaACTUALIZACIONCONTRIBUCIONDETERMINADA,ideam2021inventario}.
...
\vspace{0.2cm}
\footnotesize Fuente: NOAA Global Monitoring Laboratory~\cite{noaa2024ch4} / WMO~\cite{ak-bhdWEATHERCLIMATEWATER}
\end{block}
...
\textbf{80$\times$ en 20 a\~nos} y aproximadamente \textbf{27 $\times$ en 100 a\~nos}~\cite{intergovernmentalpanelonclimatechangeipccClimateChange20212023}. 
A pesar de que CH$_4$ creci\'o un 29\% en cinco d\'ecadas~\cite{ak-bhdWEATHERCLIMATEWATER}, 
...
con trazabilidad y continuidad~\cite{ak-bhdWEATHERCLIMATEWATER,jenkinsProcessingPoultryManure2025,rossiEstimatingDynamicsGreenhouse2024a}
...
fortalece la autonomía técnica para decidir sobre los residuos~\cite{carolanAutomatedAgrifoodFutures2020,klerkxReviewSocialScience2019a}
...
\begin{itemize}
    \item \textbf{Omn\'ivora extrema}: consume residuos vegetales, animales, fecales, y
          agroindustriales~\cite{singhInclusiveApproachOrganic2019a,bermudez-serranoComprehensiveUtilizationBlack2023}
   \item \textbf{Alta Eficiencia}: reduce masa de residuos 50--80\% en 10--14 d\'ias~\cite{singhInclusiveApproachOrganic2019a,surendraBioconversionOrganicWastes2016}
    \item \textbf{Crecimiento exponencial}: larva multiplica su peso hasta 
          \textbf{1.000$\times$} en dos semanas~\cite{padmanabhaComprehensiveDynamicGrowth2020,eriksenDynamicModellingFeed2022}
    \item \textbf{Resiliente tropical}: tolera 15--40$^\circ$C, ideal para el tr\'opico 
          sin climatizaci\'on costosa~\cite{salamEffectDifferentEnvironmental2022}
\end{itemize}
\end{block}
\end{column}

\begin{column}{0.48\textwidth}
\begin{block}{Valorizaci\'on total del residuo \cite{bermudez-serranoComprehensiveUtilizationBlack2023}}
\footnotesize
\begin{itemize}
...
\begin{enumerate}
    ...
    en el reactor de bioconversi\'on~\cite{singhInclusiveApproachOrganic2019a,bermudez-serranoComprehensiveUtilizationBlack2023}.
    
    \item \textbf{Proceso:} Larvas de \BSF{} consumen los residuos en condiciones controladas:
    \begin{itemize}
        \item Temperatura: 25--30$^\circ$C~\cite{salamEffectDifferentEnvironmental2022}
        \item Humedad del sustrato: 60--70\%~\cite{bekkerImpactSubstrateMoisture2021a}
        \item Proceso \textbf{aer\'obico}~\cite{dienerConversionOrganicMaterial2011}
        \item Duraci\'on: 10--14 d\'ias~\cite{dienerConversionOrganicMaterial2011,surendraBioconversionOrganicWastes2016}
    \end{itemize}
    
    \item \textbf{Salidas:}
    \begin{itemize}
        \item \textbf{Biomasa larval:} prote\'ina animal para alimento de peces y 
        aves~\cite{bermudez-serranoComprehensiveUtilizationBlack2023}
        \item \textbf{Frass:} fertilizante org\'anico rico en 
        nutrientes~\cite{bermudez-serranoComprehensiveUtilizationBlack2023}
    \end{itemize}
    
    \item \textbf{Emisiones:} CO$_2$ y CH$_4$ generados durante el metabolismo larval --- 
    \textcolor{red}{\textbf{variables a predecir y mitigar}}~\cite{rossiEstimatingDynamicsGreenhouse2024a,fuhrmannComprehensiveIndustryrelevantBlack2025a}.
\end{enumerate}
\end{block}
...
\begin{itemize}
    ...
    \item \textbf{Dieta y respiración parcialmente caracterizadas} $\rightarrow$ modelos DEB \parencite{eriksenDynamicModellingFeed2022,padmanabhaComprehensiveDynamicGrowth2020} y estudios de metabolismo larval \parencite{bekkerImpactSubstrateMoisture2021a,rossiEstimatingDynamicsGreenhouse2024a} describen flujos de carbono y efecto del sustrato, pero su acoplamiento con monitoreo continuo para predicción operativa de CO$_2$ y riesgo de anaerobiosis no está implementado
...
\begin{itemize}
    \item \textbf{Mediciones de GEI:} cuantifican emisiones, pero con muestreos puntuales y metodologías heterogéneas~\cite{rossiEstimatingDynamicsGreenhouse2024a,fuhrmannComprehensiveIndustryrelevantBlack2025a}.
    \item \textbf{Modelos DEB:} describen crecimiento larval y respiración de CO$_2$~\cite{padmanabhaComprehensiveDynamicGrowth2020,eriksenDynamicModellingFeed2022}.
    \item \textbf{Monitoreo IoT:} permite seguimiento operativo, aunque sin capacidad predictiva integrada~\cite{rajRealTimeEstimation2023a,duobieneDevelopmentWirelessSensor2022}.
    \item \textbf{Viabilidad ambiental:} La bioconversión con BSF muestra potencial como alternativa de baja emisión frente a rutas convencionales, pero su validación climática sigue limitada por la falta de monitoreo continuo y de factores de emisión específicos~\cite{smetanaSustainableUseHermetia2019a,jenkinsProcessingPoultryManure2025}.
\end{itemize}
\end{block}
...
\scriptsize
\begin{itemize}
    \item EDO simplificado siguiendo el marco DEB para BSF \textcite{eriksenDynamicModellingFeed2022}
