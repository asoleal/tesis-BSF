...
larvas, dietas D1/D4, cierres de acumulacion con bandeja control del mismo dia, supuesto S7). Las tasas extraidas, con su R$^2$ de ajuste, estan en
\texttt{datos/experimentos/datos\_finales\_PINN\_corregidos.csv}.
...
\begin{enumerate}
  ...
  subestiman la mezcla real; la discrepancia se cerrara con la calibracion
  ...
  observados; su entrenamiento definitivo queda para los
