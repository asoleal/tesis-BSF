...
\hline
\textbf{Variable} & \textbf{Tipo} & \textbf{Sensor requerido} & \textbf{Frecuencia} & \textbf{Relacion con GEI} \\ \hline
\textbf{CO\textsubscript{2}} & Directa & NDIR (0--10,000 ppm) & 1 min & $\propto$ metabolismo aerobico larval + actividad microbiana \\ \hline
\textbf{CH\textsubscript{4}} & Directa & Sensor MOS/electroquimico & 5 min & $\propto$ zonas anaerobicas en sustrato (funcion de humedad $>$70\% y compactacion) \\ \hline
\textbf{Temperatura} & Directa & Termopar PT100 & 1 min & Controla Q\textsubscript{10} metabolico: $R(T) = R_{25} \times 2^{((T-25)/10)}$ \\ \hline
\textbf{Humedad relativa} & Directa & Capacitivo & 1 min & $>$75\% $\rightarrow$ riesgo de anaerobiosis $\rightarrow$ $\uparrow$CH\textsubscript{4} \\ \hline
\textbf{pH} & Directa & Electrodo combinado & 10 min & $<$5.5 $\rightarrow$ inhibicion microbiana; $>$8.0 $\rightarrow$ $\uparrow$NH\textsubscript{3} volatilizacion \\ \hline
\textbf{Conductividad} & Directa & Sonda de 4 anillos & 10 min & $\propto$ acumulacion de sales (NH\textsubscript{4}\textsuperscript{+}, K\textsuperscript{+}) $\rightarrow$ estres larval \\ \hline
\textbf{O\textsubscript{2}} & Directa & Sensor optico & 1 min & $<$15\% $\rightarrow$ inicio de condiciones anaerobicas \\ \hline
\textbf{Biomasa larval} & Latente & Inference PGNN & 24h & $\propto$ eficiencia de conversion de carbono (FCE) \\ \hline
\textbf{N\textsubscript{2}O} & Latente & Inference PGNN & 1h & $f$(pH, NO\textsubscript{3}\textsuperscript{-} residual, humedad, T) \\ \hline
\textbf{Actividad microbiana} & Latente & Inference PGNN & 1h & $\propto$ tasa de mineralizacion del C \\ \hline
\end{tabular}
\end{table}
