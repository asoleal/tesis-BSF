...
La producción de metano ($CH_{4}$) durante esta fase exhibió un comportamiento de umbral dependiente (Figura \ref{fig:fase1}). Las emisiones permanecieron en niveles no detectables (0 ppm) mientras existió disponibilidad de oxígeno, manifestándose un pico incipiente (800 ppm) únicamente tras la saturación de $CO_{2}$. Este comportamiento valida el modelo teórico de \cite{ahlamineMathematicalAnalysisAnaerobic2024}, confirmando que la metanogénesis bacteriana es un evento secundario que se desencadena tras el agotamiento del oxígeno en el macro-ambiente.
