...
este documento. El modelo de Eriksen \cite{eriksen2022} es una red de balances
...
\end{tikzpicture}
\caption{El modelo de Eriksen \cite{eriksen2022} como red de compartimentos
...
procesos metabólicos distintos \cite{eriksen2022}. El primero es el
...
El modelo de Eriksen \cite{eriksen2022} se obtiene al particularizar la
...
Eriksen \cite{eriksen2022} emerge así como un caso particular de esta
