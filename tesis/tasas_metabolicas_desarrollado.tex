...
El par\'{a}metro $m = \SI{0.08}{\per\day}$ fue estimado por \textcite{laganaroGrowthMetabolicPerformance2021a} a partir de respirometr\'{i}a en sustrato de pollo. Notablemente, $m$ no depende de $L$: los l\'{i}pidos de almacenamiento no requieren gasto energ\'{e}tico para mantener su integridad, a diferencia de los tejidos estructurales vivos.
...
El costo de s\'{i}ntesis lip\'{i}dica $Y_L = \num{0.42}$ refleja la eficiencia de convertir carbohidratos en triacilgliceroles (ratio molar 72:168 de $\mathrm{CO_2}$:l\'{i}pido, seg\'{u}n \textcite{kokPreliminaryProjectDesign2021}). Cuando $r_L < 0$, los l\'{i}pidos se oxidan sin costo adicional ($r_{\mathrm{CO_2},L}=0$), ya que la hidr\'{o}lisis es energ\'{e}ticamente neutra o ligeramente exot\'{e}rmica.
