...
Los parámetros semilla se extraen del modelo DEB individual de \textcite{eriksenDynamicModellingFeed2022}, escalados a reactor batch mediante la densidad larval inicial. Estos valores se consideran a priori biofísicamente plausibles y no se alteran durante la calibración local:
