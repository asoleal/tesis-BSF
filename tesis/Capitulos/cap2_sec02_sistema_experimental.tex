...
La humedad inicial del sustrato se reguló a $65\%\pm5\%$ mediante adición controlada de agua destilada, valor dentro del intervalo 60\%--80\% que \textcite{bekkerImpactSubstrateMoisture2021a} identifican como crítico para el mantenimiento de la tasa de asimilación y el crecimiento exponencial larval. 
