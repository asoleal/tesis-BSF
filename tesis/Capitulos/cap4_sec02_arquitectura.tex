...
\label{eq:forzantes}
\end{equation}
donde $T$ es la temperatura del sustrato (\si{\celsius}), $\mathrm{HR}$ la humedad relativa del aire de cabeza libre (\si{\percent}) y $t$ el tiempo transcurrido desde la siembra (días). El estado biológico no observable es la biomasa viva total $B(t)$ (\si{\gram}), que el DEB predice a través de los compartimentos de carbono definidos en el Capítulo~\ref{chap:modelo_deb}.
