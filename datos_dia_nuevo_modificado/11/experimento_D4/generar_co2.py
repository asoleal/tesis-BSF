...
archivo_entrada = 'experimento_co2.csv'  # Cambia este nombre por el archivo que quieres procesar
#archivo_entrada = 'experimento1ch4.csv'
# ======================================================
...
if 'alimento' in base_name:
    titulo = f'Experimento {numero_experimento} - Concentración de CO2 (larvas + dieta D1)'
else:
    #####################################################################################
    titulo = f'Concentración de CO2 generada por larvas y dieta D4'
    #titulo = f'Experimento {numero_experimento} - Concentración de CH4 generada por larvas y dieta D1'
    #######################################################################################
